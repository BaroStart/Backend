...
interface AuthApi {
    ...
    fun login(@io.swagger.v3.oas.annotations.parameters.RequestBody body: LoginRequestDto, request: HttpServletRequest): ResponseEntity<ApiResponse<TokenPairResponseDto>>
