...
class AuthController(
    ...
    override fun login(request: HttpServletRequest): ResponseEntity<ApiResponse<TokenPairResponseDto>> = ApiResponse.success(SuccessCode.REQUEST_OK, authQueryUseCase.login(request))
